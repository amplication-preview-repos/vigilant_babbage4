...
@InputType()
class SessionCreateNestedManyWithoutConversationsInput {
...
export { SessionCreateNestedManyWithoutConversationsInput as SessionCreateNestedManyWithoutConversationsInput };
