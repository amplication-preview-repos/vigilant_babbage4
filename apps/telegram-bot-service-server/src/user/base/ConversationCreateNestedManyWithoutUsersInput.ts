...
@InputType()
class ConversationCreateNestedManyWithoutUsersInput {
...
export { ConversationCreateNestedManyWithoutUsersInput as ConversationCreateNestedManyWithoutUsersInput };
